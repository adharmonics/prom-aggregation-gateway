...
# HELP gauge A gauge
# TYPE gauge gauge
gauge 57 1592944812718
# HELP counter A counter
# TYPE counter counter
counter 29 1592944812718
# HELP histogram A histogram
# TYPE histogram histogram
histogram_bucket{le="1"} 0 1592944812718
histogram_bucket{le="2"} 0 1592944812718
histogram_bucket{le="3"} 0 1592944812718
histogram_bucket{le="4"} 4 1592944812718
histogram_bucket{le="5"} 5 1592944812718
histogram_bucket{le="6"} 5 1592944812718
histogram_bucket{le="7"} 5 1592944812718
histogram_bucket{le="8"} 5 1592944812718
histogram_bucket{le="9"} 5 1592944812718
histogram_bucket{le="10"} 5 1592944812718
histogram_bucket{le="+Inf"} 5 1592944812718
histogram_sum 4.5 1592944812718
histogram_count 1 1592944812718
`
	want = `# HELP counter A counter
# TYPE counter counter
counter 60 1592944812718
# HELP gauge A gauge
# TYPE gauge gauge
gauge 99 1592944812718
# HELP histogram A histogram
# TYPE histogram histogram
histogram_bucket{le="1"} 0 1592944812718
histogram_bucket{le="2"} 0 1592944812718
histogram_bucket{le="3"} 3 1592944812718
histogram_bucket{le="4"} 8 1592944812718
histogram_bucket{le="5"} 9 1592944812718
histogram_bucket{le="6"} 9 1592944812718
histogram_bucket{le="7"} 9 1592944812718
histogram_bucket{le="8"} 9 1592944812718
histogram_bucket{le="9"} 9 1592944812718
histogram_bucket{le="10"} 9 1592944812718
histogram_bucket{le="+Inf"} 9 1592944812718
histogram_sum 7 1592944812718
histogram_count 2 1592944812718
`
...
# TYPE counter counter
counter{a="a",b="b"} 2 1592944812718
`
	multilabelResult = `# HELP counter A counter
# TYPE counter counter
counter{a="a",b="b"} 3 1592944812718
`
	labelFields1 = `# HELP ui_page_render_errors A counter
# TYPE ui_page_render_errors counter
ui_page_render_errors{path="/org/:orgId"} 1 1592944812518
ui_page_render_errors{path="/prom/:orgId"} 1 1592944812518
`
	labelFields2 = `# HELP ui_page_render_errors A counter
# TYPE ui_page_render_errors counter
ui_page_render_errors{path="/prom/:orgId"} 1 1592944812718
`
	labelFieldResult = `# HELP ui_page_render_errors A counter
# TYPE ui_page_render_errors counter
ui_page_render_errors{path="/org/:orgId"} 1 1592944812518
ui_page_render_errors{path="/prom/:orgId"} 2 1592944812718
`
	gaugeInput = `
# HELP ui_external_lib_loaded A gauge with entries in un-sorted order
# TYPE ui_external_lib_loaded gauge
ui_external_lib_loaded{name="ga",loaded="true"} 1 1592944812718
ui_external_lib_loaded{name="Intercom",loaded="true"} 1 1592944812718
ui_external_lib_loaded{name="mixpanel",loaded="true"} 1 1592944812718
`
	gaugeOutput = `# HELP ui_external_lib_loaded A gauge with entries in un-sorted order
# TYPE ui_external_lib_loaded gauge
ui_external_lib_loaded{loaded="true",name="Intercom"} 2 1592944812718
ui_external_lib_loaded{loaded="true",name="ga"} 2 1592944812718
ui_external_lib_loaded{loaded="true",name="mixpanel"} 2 1592944812718
`
	duplicateLabels = `
...
# TYPE counter counter
counter{b="b",a="a"} 2 1592944812718
`
